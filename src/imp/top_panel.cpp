...
TopPanel::TopPanel(QWidget *parent) :
    ...
    d->btn_cut = new QRockyButton("Cut");
    d->btn_cut->setCombineBorders(QRockyStyle::Combine_Right);
    d->btn_cut->setMinMaxSize(qRound(2*em), qRound(2*em));
    d->btn_copy = new QRockyButton("Cpy");
    d->btn_copy->setCombineBorders(QRockyStyle::Combine_Left | QRockyStyle::Combine_Right);
    d->btn_copy->setMinMaxSize(qRound(2*em), qRound(2*em));
    ...
    layout->addSpacing(qRound(em));
    layout->addWidget(d->btn_cut);
    layout->addWidget(d->btn_copy);
    layout->addWidget(d->btn_paste);
    layout->addSpacing(qRound(em));
